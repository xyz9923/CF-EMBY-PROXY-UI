...
<p align="center">
  <img alt="version" src="https://img.shields.io/badge/version-V18.6-2563eb">
...
2. 在 Cloudflare 中进入 **Workers 和 Pages**，选择连接 GitHub 仓库创建 Worker
3. 选择本仓库后，保持仓库根目录为部署根目录
4. Cloudflare 会读取仓库内的 `wrangler.toml`，并以 `worker.js` 作为入口文件
5. 如果你希望修改 Worker 名称，直接改就可以，无视报错
